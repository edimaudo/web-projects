...
@ $db = new mysqli('localhost', 'username', 'password', 'books');//update with your own user crednetials
...
echo htmlspecialchars(stripslashes($row['title'])); echo "</strong><br />Author: ";
echo stripslashes($row['author']); echo "<br />ISBN: ";
echo stripslashes($row['isbn']); echo "<br />Price: ";
