...
$score++; }
//convert score to a percentage $score = $score / 3 * 100;
if($score < 50) {
// this person failed echo "<h1>
<p align=\"center\">
<img src=\"rosette.gif\" alt=\"\" />
Sorry:
<img src=\"rosette.gif\" alt=\"\" /></p></h1>
...
// create a string containing the score to one decimal place $score = number_format($score, 1);
echo "<h1 align=\"center\">
<img src=\"rosette.gif\" alt=\"\" /> Congratulations!
...
<form action=\"rtf.php\" method=\"post\"> <div align=\"center\">

<input </div> <input <input </form>
...
<div align=\"center\">
<input type=\"image\" src=\"certificate.gif\" border=\"0\"></div> 
...
type=\"image\" src=\"certificate.gif\" border=\"0\">
type=\"hidden\" name=\"score\" value=\"".$score."\"/> type=\"hidden\" name=\"name\" value=\"".$name."\"/>
</form>";
} 
}
?>
